...
subroutine importbeadcoords(y,dy)  
  ...
  open(2,file='A01500.dat',status='unknown')
...
program main
  ...
  real*8 :: t=0.d0, dt= 0.025!0.0125!0.1d0!0.00625d0!0.0125d0!0.00625d0!0.0125d0!0.3992!0.05d0!0.2!0.1!0.05!0.025!0.0125d0!0.00625d0
...
!!!For two particle simulations switch on generate af!!!
 ...
 !!! call setIC_sinusoid(y)
  ...
  write(20,*)t,y(1),y(2),y(3),y(4),y(5),y(6),y(7),y(8)
  !,dy(1),dy(2),dy(3),dy(4)
...
subroutine combined_VEL(i,j,V,relpos)
  ...
  integer :: i,j
!!!real*8 :: V1(2), V2(2),
  real*8 :: V(2), relpos(2),v_s(2),alpha
  alpha = 0.d0
...
subroutine setIC(y)
  ...
  do i=1,imax
     ...
     if(i .eq. 1)then
        ...
        y(2*i) = 0.5d0*Ly
     elseif(i .ne. 1)then
        !###Rest all particles at standard inter-particle separation
        y(2*i-1) = dble( (i-1)+0.5)*drho(1)
        y(2*i) = 0.5d0*Ly
     end if
...
subroutine setIC_sinusoid(y)
  ...
  fac2 = 2.d0!0.05d0! 0.0125d0! 0.3d0! 0.5d0
