module swap_traj_para
  implicit none
  real*8 :: kappa=6.50d0!!!5.8d0!5.5d0!4.2!3.2d0
...
allocate(t(2*num2),y(2*num2),dy(2*num2))
  call read_para(t,y,dy,num2)
...
subroutine read_para(t,y,dy,n)
  use file_para
  implicit none
  integer :: k,n
  real*8 :: t(2*n),y(2*n),dy(2*n)
