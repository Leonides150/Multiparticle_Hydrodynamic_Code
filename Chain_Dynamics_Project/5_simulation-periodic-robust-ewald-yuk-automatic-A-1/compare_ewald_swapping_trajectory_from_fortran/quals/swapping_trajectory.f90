module swap_traj_para
  implicit none
  !real*8 :: kappa=8.50d0
  real*8 :: kappa=9.d0!!!6.d0!!!9.d0!!!5.8d0!5.5d0!4.2!3.2d0
...
!  real*8 :: b=0.d0,x0=1.95d0!b=2.8d0,x0=1.65d0!!b=2.d0,x0=1.782d0!0.65d0
  ...
  !!!real*8 :: b=1.5d0,x0=1.95d0,rev_h=0.5d0, z_shift = 0.d0
!!!real*8 :: b=1.6d0,x0=1.95d0,rev_h=1.d0, z_shift = 0.d0
!!!real*8 :: b=4.d0,x0=1.95d0,rev_h=20.d0, z_shift = 1.2d0
  
!!!  real*8 :: b=3.5d0,x0=2.d0,rev_h=0.3d0, z_shift = 1.2d0
  real*8 :: b=1.d0,x0=2.d0,rev_h=0.5d0, z_shift = 1.2d0
...
subroutine swap_traj_amp_auto_calc
  use swap_traj_para
  implicit none
  real*8 :: ro_st(2),ro_st_mag,ro_z_st
  real*8 :: p,g,q
  ...
  g = (ro_st(1) * (ro_z_st + z_shift))/((rev_h + exp(kappa*ro_st_mag_shift))*(b**2 + ro_st_mag**2)**2)
