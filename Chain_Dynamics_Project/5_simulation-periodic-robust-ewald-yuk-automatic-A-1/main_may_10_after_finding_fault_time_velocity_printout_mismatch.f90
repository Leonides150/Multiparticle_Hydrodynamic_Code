...
module parameters_main
  ...
  integer :: nosteps=1!50000!99900!1024!2048!4096!8192!16384!32768
...
subroutine importbeadcoords(y,dy)  
  ...
  open(2,file='phi0.05_76_new.txt',status='unknown')
...
program main
  ...
  real*8 :: t=0.d0, dt=0.05d0!0.2!0.1!0.05!0.025!0.0125d0!0.00625d0
...
!!!!For outputting velocity!!!!
     y(1) = 10.990101743555616!9.5199999999999996!10.990101743555616!
     y(2) = 1.9199999998669040!1.9199999999999999!1.9199999998669040!
     y(3) = 12.049898256545090!13.520000000000000!12.049898256545090!
     y(4) = 1.9199999998607633!1.9199999999999999!1.9199999998607633!
     relpos(1) = y(3)-y(1)
     relpos(2) = y(4)-y(2)
     ...
     write(*,*)'relative_pos',relpos(1),relpos(2)
     write(*,*)'ewald=',REALPART(grad_ewald)
     write(*,*)'derives=',dy
     call exportbeadcoords(y,dy,numpar)
     !write(3,*)l,pos_diff,V2,V1
     write(20,*)t,yo(1),yo(2),yo(3),yo(4),dy(1),dy(2),dy(3),dy(4),REALPART(grad_ewald(1)),REALPART(grad_ewald(1))
     y=yo; t=t+dt
