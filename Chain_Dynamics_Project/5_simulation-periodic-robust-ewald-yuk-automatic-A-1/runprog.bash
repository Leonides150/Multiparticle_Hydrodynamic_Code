...
#dirname="swap_traj_seed-${seed_val}-square_cell-af-${af}-numpar=${numpar}-pot_para-$ka-ka-$m_yuk-m-${Aswap}-Aswap-dt0.05"
#dirname="swap_traj_seed-1-square_cell-af-0.3-numpar=456-dt0.05-V12"
#dirname="yuk_fac_1_full_sim_after_fit_square-cell_af-${af}_numpar=${numpar}_k-${ka}_m-${m_yuk}_dt-0_00625-b-0_x0_5-1_90"
#dirname="particles_${numpar}_seed-${seed_val}_af-${af}_k-${ka}_m-${m_yuk}_b-0_5_x0-1_90"
#dirname="SC_aps_seed-2_af-0.3_numpar=1024-pot_para-3-ka-4-m"
#dirname="low_density_0_05_GWU_initial_condition_dt0_0125_with_y_swap_added_alpha0_3"
###dirname="low_density_0_05_GWU_initial_condition_dt0_0125"
#dirname="high_density_0_3_GWU_initial_conditiondt0_0125"
#dirname="high_density_0_3_GWU_initial_condition_dt0_0125_with_swap"
#dirname="dipolar_array_test2_numerical_tests_af-0.001_dx-3a"
dirname="dipolar_periodic_array_test_"
...
#runname=main_${numpar}_${af}_${seed_val}
runname=main_${numpar}_${af}_00125
