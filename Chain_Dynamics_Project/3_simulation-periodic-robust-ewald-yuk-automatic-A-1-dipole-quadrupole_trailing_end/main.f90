...
!!!  call trailing_end_potential(y,dy)
...
!!!FIVE PARTICLE PLACEMENT!!!
  ...
  num=numpar/2
  do i=1,num
     y(2*i-1) = Lx*0.5d0 - dble(i)*dia
     y(2*i) = Ly*0.5d0 + dble(i)*dia - 0.5d0*dia
  end do
  do i=num+1,numpar
     y(2*i-1) = Lx*0.5d0 - dble(i-num)*dia
     y(2*i) = Ly*0.5d0 - dble(i-num)*dia 
  end do
!  do i=51,numpar
!     
!     y(2*i-1)= 14.d0 !18.3d0
!     y(2*i)= dble(i-50)
!     
!  end do
