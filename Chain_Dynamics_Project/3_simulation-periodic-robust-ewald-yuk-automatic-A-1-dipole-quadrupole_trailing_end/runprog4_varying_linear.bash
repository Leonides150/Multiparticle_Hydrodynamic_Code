...
### 0.05
### 0.025
numpar=8  ### 20  #44 #number of particles after numpar_extra ###so Total base particles are assumed to be 50
...
### dirname="${numpar}-particle_${Lx}-Lx_${Ly}_Ly_${dt}-dt_gstren-${g_stren}_cell-frac0.5dipolar_self-term-0_trailing_end_vfront"
dirname="${numpar}-particle_${Lx}-Lx_${Ly}_Ly_${dt}-gstren-${g_stren}-dipolar_chain_investigations_3"
