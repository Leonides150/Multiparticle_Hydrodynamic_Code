...
##Motivation
The aim of this project was to study droplet dynamics in confined channels for very large systems. The main motivation was obtaining results in times much shorter than Direct Simulations. This was achieved by the process of including interactions via droplet images via the Ewald type sumations.
...
4. This instance includes antisymmetric (Hele--Shaw Dipolar) interactions between particles. Therefore, it also includes tests to check the code accuracy and convergence of first the dipolar system and the nthe combined dipolar-quadrupolar system.
5. This is the initial fully-tested version of the code capable of simulating symmetric interaction between particles.
