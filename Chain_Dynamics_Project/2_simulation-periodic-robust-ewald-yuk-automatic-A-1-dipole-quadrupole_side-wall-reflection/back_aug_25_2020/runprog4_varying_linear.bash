...
dirname="${numpar}-particle_${Lx}-Lx_${Ly}_Ly_${dt}-dt_gstren-${g_stren}_cell-frac0.5dipolar_self-term-0_side_wall-front_vel-trailing_end_double-piston_frac_x-0.32"
