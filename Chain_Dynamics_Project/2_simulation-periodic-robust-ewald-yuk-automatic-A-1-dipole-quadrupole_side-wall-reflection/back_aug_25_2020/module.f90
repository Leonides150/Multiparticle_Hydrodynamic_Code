...
module random_parameters
  ...
  real*8 :: factor
  real*8 :: frac_x=0.32d0, frac_y=0.5d0, shift_frac=0.25d0 !frac_x=1.d0, frac_y=0.5d0, shift_frac=0.d0
...
module para_bk
  ...
  real*8 :: x_st_ft=95.d0, frac_ft=1.d0 !x_st_ft=96.5d0, frac_ft=1.d0!90.d0, frac_ft=1.d0 !200p x_st_ft=120.d0, frac_ft=1.d0 !50 p x_st_ft=30.d0, frac_ft=1.d0 
