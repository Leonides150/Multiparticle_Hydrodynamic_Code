...
### 0.05
### 0.025
numpar=50  ### 20  #44 #number of particles after numpar_extra ###so Total base particles are assumed to be 50
...
dirname="${numpar}-particle_${Lx}-Lx_${Ly}_Ly_${dt}-dt_dipolar__noswap_helf-cell_self-term-0_Gauss_10"
### dirname="test_1"
...
runname=main_${numpar}_${Lx}_${Ly}_${dt}
